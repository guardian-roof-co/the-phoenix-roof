  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      await syncToHubSpot({
          ...
          phone: userPhone,
          notes: `AI Policy Review Summary:\n\n${analysisText.substring(0, 1000)}...`,
          lead_source: 'AI Insurance Analyzer'
      });
      setIsSyncing(false);
      ...
      <div className="grid lg:grid-cols-2 gap-12 items-start">
        ...
        <div className="bg-white rounded-[3rem] shadow-2xl p-8 border border-slate-100 space-y-8">
          ...
          <div className="space-y-4">
             ...
             <div 
                className={`border-2 border-dashed rounded-[2.5rem] h-64 flex flex-col items-center justify-center transition-all overflow-hidden relative ${
          ...
          <button
            ...
            className={`w-full py-5 rounded-[2rem] font-black text-white transition-all shadow-xl flex items-center justify-center gap-3 uppercase tracking-widest ${
              !file || !userEmail ? 'bg-slate-200 cursor-not-allowed text-slate-400' : 
